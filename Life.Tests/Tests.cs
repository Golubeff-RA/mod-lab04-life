...
public class BoardTests
{
    ...
    public void BoardTest5()
    {
        ...
        var exception = Assert.ThrowsException<Exception>(() => board.LoadPattern("pattern"));
        Assert.AreEqual(exception.Message, "File pattern not found");
    }
    ...
    {
        var board = new Board(100, 100, 1);
        var exception = Assert.ThrowsException<Exception>(() => board.SaveToFile("pattern"));
        Assert.AreEqual(exception.Message, "File pattern not found");
    }
